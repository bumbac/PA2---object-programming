...
public:
    CTowerBombarda(const CTowerBombarda *original, const size_t &x, const size_t &y);

    CTowerBombarda(const size_t &x, const size_t &y, char symbol, size_t range, size_t damage, size_t price, double ration);
